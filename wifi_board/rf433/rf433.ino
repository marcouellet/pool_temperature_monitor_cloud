...
// DataTransferRF433WifiImpl rf433(2000, 4, 5, 0); // ESP8266 or ESP32: do not use pin 11 or 2
// DataTransferRF433WifiImpl rf433(2000, 3, 4, 0); // ATTiny, RX on D3 (pin 2 on attiny85) TX on D4 (pin 3 on attiny85), 
// DataTransferRF433WifiImpl rf433(2000, PD14, PD13, 0); STM32F4 Discovery: see tx and rx on Orange and Red LEDS
...
void loop()
{
	if ( rf433.isDataAvailable() )
    {  
        DataTransferMessage* message = rf433.getData();
        if (message != NULL) {
